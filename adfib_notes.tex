...
\end{proof}
{\chris Another class of functors which can be asserted to strictly preserves (co)limits are (op) fibrations. In more detail,...UNDERSTAND BETTER}
...
{\daniel Define Street opfibrations here or in prelimiaries?}{\chris I think better on preliminaries!}

...
\begin{itemize}
 \item {\daniel For names, we've been using
     ...
     base. }{\chris Sorry Daniel, I thought we should stick with structured cospans paper because it will heavily rely on us. That's why I had U from C to D as our basic categories! I think John wanted that too. Are you fine with that? Also I don't want X and A because in our Joe's paper we have the the other way around, X for base and A for total !!!}
     {\daniel For adjunctions, we've been using L
     and R. But that's only when we are fixing an
     adjunction.  Here we're proving things are
     adjunctions, so maybe F and G?} {\chris again, I think U was kind of suggested for our central opfibration. I don't mind that tbh.} 
     
    {\daniel I like Joe's
     mathsf font for categories.  I'll macro that
     up.}{\chris I think you mean Joe has been using mathsf for named categories? I don't remember anyone arguing about mathcal for general categories as is the norm, but again if you don't like it no prob. I'm pretty used to it I admit!} 

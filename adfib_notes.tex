...
I have kept some older stuff, we can at any point decide if they are to be discarded!}
...
\section{Grothendieck fibrations and laris}

{\chris Could we perhaps find a cool name, like coreflection, for such an adjunction? Lari refers to only one adjoint...}

...
\begin{itemize}
 \item Agree on notation. {\chris Daniel remind me the good choices for names? Total and base, fibration and opfibration, adjunctions? I made macros to save time later.}
\end{itemize}
...
In this section, we investigate conditions under which opfibrations and adjunctions with identity unit relate to one another. The main result, \cref{thm:mainthm}, essentially exhibits their bijective correspondence under the intersection of the respective conditions. {\chris say something about duality, and also in theorems below.} 

First of all, the following result is the dual of \cite[Prop. 4.4]{Grayfibredandcofibred}.

\begin{prop}
 Let $\U\colon\D\to\C$ be an opfibration. Its fibres have initial objects which are preserved by the reindexing functors
